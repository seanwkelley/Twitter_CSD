...
path="D:/Twitter_Study_FYP/Analysis5_Mar2020/Participant_Data/"
os.chdir(path)
...
with open('FYP_Twitter_Participants_23.03.csv', 'rb') as f:
    data = f.read()
...
with open('FYP_Twitter_Participants_23.03.csv.encrypted', 'wb') as f:
    f.write(encrypted)
