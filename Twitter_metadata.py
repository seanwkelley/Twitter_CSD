...
Participant_info = Dates = pd.read_csv('Participant_Data/10.04.2020/FYP_Twitter_V3_US_10.04.csv')
...
for i in range(0,len(file_names)):
    ...
    twitter_json = pd.read_json("Raw_Tweets/" + recruitment + '/' + handle + "/" + handle + '.json',encoding="utf-8",lines=True)
    ...
    twitter_vader = pd.read_csv("Raw_Tweets/" + recruitment + '/' + handle + "/" + handle + '_tweets.csv',encoding="utf-8")
